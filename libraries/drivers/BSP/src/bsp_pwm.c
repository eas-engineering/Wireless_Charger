...
bsp_pwm_pin_init(void) {
  ...
  const port_pin_config_t port_config_curr_set = {/* Internal pull-up/down resistor is disabled */
                                         kPORT_PullDisable,
...
const port_pin_config_t port_config_pwm_sync = {/* Internal pull-up/down resistor is disabled */
  ...
  PORT_SetPinConfig(CH_CURR_SET_PORT, CH_CURR_SET_PIN, &port_config_curr_set);
